class Player:
    ...
    def Expected_Adult_Age_Height(self):
        ...
        try:
            ...
            if self.info["gender"].upper() == "MALE": #and all(type(var) is str for var in [self.info["fname", "lname", "gender", "EMail"]])
                self.ExpectedH = (int(input("Please Provide Your Father's Height in CM: ")) + int(input("Please Provide Your Mother's Height in CM: ")) + 13)/2
    ...
    def suggested_sports(self):
        ...
        if self.info["BMI"] >= 18.5 and self.info["BMI"] <= 24.9:

            print("wait a second... ")

            if self.info["gender"] == "Male" and self.ExpectedH() >= 170:
                return "WOW. You're expected to be a tall boy and here is a list of sports that suit you: \n 1- Handball \n 2- Basketball \n 3- Volleyball"
                
            elif self.info["gender"] == "Male" and self.ExpectedH() < 170:
                return "You're not expected to be a very tall boy but we have a good list of sports that suit you: \n 1- Football \n 2- Badminton \n 3- Swimming"
            
            elif self.info["gender"] == "Female" and self.ExpectedH() >= 160:
    ...
    def chosen_sport(self):
        ...
        if self.info["gender"] == "Male" and self.ExpectedH() >= 170: # or (self.info["gender"] == "Female" and self.ExpectedH() >= 160):
        ...
        elif self.info["gender"] == "Male" and self.ExpectedH() < 170: # or (self.info["gender"] == "Female" and self.ExpectedH() < 160):
